...
export const styles={
    ...
    button:"flex flex-row justify-center items-center px-3 py-6 rounded-full cursor-pointer bg-[#2190ff] min-h-[35px] w-full text-[16px] font-Poppins font-semibold"
}