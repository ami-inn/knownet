...
export const getSingleCourse =  CatchAsynError(async(req:Request,res:Response,next:NextFunction) =>{
    try {
        ...
        await redis.set(courseId,JSON.stringify(course),"EX",604800) // expire on seven days
...
export const getAllCoursesAdmin = CatchAsynError(async(req:Request,res:Response,next:NextFunction) =>{
...
export const deleteCourse = CatchAsynError(async(req:Request,res:Response,next:NextFunction) => {
    try {
